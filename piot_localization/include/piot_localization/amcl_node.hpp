...
#ifndef PIOT_LOCALIZATION__AMCL_NODE_HPP_
#define PIOT_LOCALIZATION__AMCL_NODE_HPP_
...
protected:
   ...
   */
  void initOdometry();
  std::shared_ptr<piot_localization::MotionModel> motion_model_;
  ...
  double init_cov_[3];
  pluginlib::ClassLoader<piot_localization::MotionModel> plugin_loader_{"piot_localization",
    "piot_localization::MotionModel"};
  /*
   ...
   */
  piot_localization::Laser * createLaserObject();
  int scan_error_count_{0};
  std::vector<piot_localization::Laser *> lasers_;
  ...
  bool init_without_amcl_flag = false;
};

}  // namespace piot_localization

#endif  // PIOT_LOCALIZATION__AMCL_NODE_HPP_
