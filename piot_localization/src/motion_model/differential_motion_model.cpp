...
#include "piot_localization/motion_model/differential_motion_model.hpp"
...
PLUGINLIB_EXPORT_CLASS(piot_localization::DifferentialMotionModel, piot_localization::MotionModel)
