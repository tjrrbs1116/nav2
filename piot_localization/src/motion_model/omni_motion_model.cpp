...
#include "piot_localization/motion_model/omni_motion_model.hpp"
...
}  // namespace piot_localizaiton

#include <pluginlib/class_list_macros.hpp>
PLUGINLIB_EXPORT_CLASS(piot_localization::OmniMotionModel, piot_localization::MotionModel)
