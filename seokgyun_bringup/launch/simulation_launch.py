...
def generate_launch_description():
    ...
    sim_world = os.path.join(get_package_share_directory('turtlebot3_gazebo'),'worlds','turtlebot3_house.world')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_dir, 'params', 'simulation.yaml'),
    ...
    declare_robot_name_cmd = DeclareLaunchArgument(
        'robot_name',
        default_value='waffle', #turtlebot3_waffle
